...
# Terraform import script for ShogiProject_Analysis CodeBuild project and IAM resources

echo "Initializing Terraform..."
terraform init

echo "Importing IAM role..."
terraform import aws_iam_role.codebuild_service_role codebuild-build-sgp-app-analysis-service-role
...
echo "terraform import aws_iam_policy.common_exec_sam_policy arn:aws:iam::ACCOUNT_ID:policy/policy-sgp-app-analysis-exec-sam"
...
terraform import aws_codebuild_project.sgp_app build-sgp-app-analysis

echo "Importing CodeBuild webhook..."
terraform import aws_codebuild_webhook.sgp_app build-sgp-app-analysis
